...
======================
To reproduce Figure 6 in our paper, do:

>> cd PUT_PATH_TO_ROOT_WHERE_THIS_README_FILE_IS
>> cd IPALM
>> g++ -o main main.cpp -lgsl -lgslcblas
>> ./main 5 b qcqp1 1 1 200 10 1 100 50 ; ./main 5 b qcqp2 1 1 170 20 10 3 50 ; ./main 5 b qcqp3 1 1 200 30 10 1 50 ; ./main 5 b qcqp4 1 1 190 500 1 1000 50
