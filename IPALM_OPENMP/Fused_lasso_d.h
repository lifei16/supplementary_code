#ifndef FUSED_LASSO_D_H
#define FUSED_LASSO_D_H
...
//This class solves problem: min_x f(x)+ g(x)+ h(Mx) by ASGARD_DL;
...
class Fused_lasso_d: public ALM_APG<L, D>
{
private:
...
public:
  ...
  Fused_lasso_d(const char* Matrix_file,const char* Matrix_file2, D val_lambda1, D val_lambda2, D val_lambda3)
  ...
  Fused_lasso_d(const char* Matrix_file, D val_lambda1, D val_lambda2, D val_lambda3)
